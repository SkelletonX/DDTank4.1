...
{
    public class CASE1359A : BasePetEffect
    {
        private int int_0;
        private int int_1;
        private int int_2;
        ...
        private int int_5;
        private int int_6;
        public CASE1359A(int count, int probability, int type, int skillId, int delay, string elementID) : base(ePetEffectType.CASE1359A, elementID)
        {
            this.int_1 = count;
            this.int_4 = count;
        ...
        {
            CASE1359A cE = living.PetEffectList.GetOfType(ePetEffectType.CASE1359A) as CASE1359A;
            if (cE != null)
            {
        ...
        private void method_1(Living living_0)
        {
            ...
            this.int_6 = living_0.MaxBlood * 4 / 100;
