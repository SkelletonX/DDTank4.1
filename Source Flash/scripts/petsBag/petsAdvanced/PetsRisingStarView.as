      ...
      private function updateData() : void
      {
         ...
         else if(this._petStarInfo)
         {
            ...
            if(_petInfo.Level < 30)
            {
               ...
               {
                  this._propLevelArr_one[_loc7_] = this._propLevelArr_one[_loc7_] + ((_petInfo.Level - 1) * this._growLevelArr_one[_loc7_] - _currentPropArr[_loc7_]);
                  this._growLevelArr_one[_loc7_] = this._growLevelArr_one[_loc7_] - _currentGrowArr[_loc7_];
            ...
            else if(_petInfo.Level < 50)
            {
               ...
               {
                  this._propLevelArr_two[_loc8_] = this._propLevelArr_two[_loc8_] + ((_petInfo.Level - 30) * this._growLevelArr_two[_loc8_] + 29 * this._growLevelArr_one[_loc8_] - _currentPropArr[_loc8_]);
                  this._growLevelArr_two[_loc8_] = this._growLevelArr_two[_loc8_] - _currentGrowArr[_loc8_];
            ...
            else
            {
               ...
               {
                  this._propLevelArr_three[_loc9_] = this._propLevelArr_three[_loc9_] + ((_petInfo.Level - 50) * this._growLevelArr_three[_loc9_] + 20 * this._growLevelArr_two[_loc9_] + 29 * this._growLevelArr_one[_loc9_] - _currentPropArr[_loc9_]);
                  this._growLevelArr_three[_loc9_] = this._growLevelArr_three[_loc9_] - _currentGrowArr[_loc9_];
