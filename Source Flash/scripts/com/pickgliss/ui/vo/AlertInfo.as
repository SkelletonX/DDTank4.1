package com.pickgliss.ui.vo
{
   ...
   public class AlertInfo extends EventDispatcher
   {
      ...
      public static const CANCEL_LABEL:String = "Cancelar";
      
      public static const SUBMIT_LABEL:String = "Confirmar";
      ...
      private var _cancelLabel:String = "Cancelar";
      ...
      private var _submitLabel:String = "Confirmar";
      ...
      public function AlertInfo(param1:String = "", param2:String = "Confirmar", param3:String = "Cancelar", param4:Boolean = true, param5:Boolean = true, param6:Object = null, param7:Boolean = true, param8:Boolean = true, param9:Boolean = true, param10:Boolean = true, param11:int = 13, param12:int = 30, param13:Boolean = false)
      {
