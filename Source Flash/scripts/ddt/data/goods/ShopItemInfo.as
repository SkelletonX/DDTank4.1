package ddt.data.goods
{
   ...
   public class ShopItemInfo extends EventDispatcher
   {
      ...
      public function get isFree() : Boolean
      {
         ...
         while(_loc2_ < 3)
         {
            _loc1_ = _loc1_ + this.getItemPrice(_loc2_).moneyValue;
            _loc1_ = _loc1_ + this.getItemPrice(_loc2_).goldValue;
            _loc1_ = _loc1_ + this.getItemPrice(_loc2_).medalValue;
            _loc1_ = _loc1_ + this.getItemPrice(_loc2_).giftValue;
            _loc2_++;
         }
         return _loc1_ <= 0;
      }
