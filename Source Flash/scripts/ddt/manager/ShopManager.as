   ...
   public class ShopManager extends EventDispatcher
   {
      ...
      public function buyIt(param1:Array) : Array
      {
         ...
         for each(_loc8_ in param1)
         {
            ...
            {
               _loc4_ = _loc4_ - _loc8_.getItemPrice(_loc8_.currentBuyType).goldValue;
               _loc5_ = _loc5_ - _loc8_.getItemPrice(_loc8_.currentBuyType).moneyValue;
               _loc6_ = _loc6_ - _loc8_.getItemPrice(_loc8_.currentBuyType).giftValue;
               _loc7_ = _loc7_ - _loc8_.getItemPrice(_loc8_.currentBuyType).medalValue;
               _loc3_.push(_loc8_);
            }
         }
         return _loc3_;
      ...
      public function giveGift(param1:Array, param2:SelfInfo) : Array
      {
         ...
         for each(_loc6_ in param1)
         {
            ...
            {
               _loc4_ = _loc4_ - _loc5_.moneyValue;
               _loc3_.push(_loc6_);
            }
         }
         return _loc3_;
