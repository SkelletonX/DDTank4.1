...
{
	public class CE1612 : BasePetEffect
	{
		...
		public CE1612(int count, int probability, int type, int skillId, int delay, string elementID)
			: base(ePetEffectType.CE1612, elementID)
		{
			m_count = count;
			m_coldDown = count;
		...
		{
			CE1612 cE = living.PetEffectList.GetOfType(ePetEffectType.CE1612) as CE1612;
			if (cE == null)
			{
