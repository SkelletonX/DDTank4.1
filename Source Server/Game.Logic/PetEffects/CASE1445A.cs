...
{
    public class CASE1445A : BasePetEffect
    {
        private int int_0;
        private int int_1;
        private int int_2;
        ...
        private int int_5;
        private int int_6;
        public CASE1445A(int count, int probability, int type, int skillId, int delay, string elementID) : base(ePetEffectType.CASE1445A, elementID)
        {
            this.int_1 = count;
            this.int_4 = count;
        ...
        {
            CASE1445A cE = living.PetEffectList.GetOfType(ePetEffectType.CASE1445A) as CASE1445A;
            if (cE != null)
            {
