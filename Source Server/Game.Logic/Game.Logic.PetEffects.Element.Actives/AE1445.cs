...
namespace Game.Logic.PetEffects.Element.Actives
{
	public class AE1445 : BasePetEffect
	{
		...
		{
			AE1445 aE = living.PetEffectList.GetOfType(ePetEffectType.AE1445) as AE1445;
			if (aE == null)
			{
		...
		private void player_AfterBuffSkillPetByLiving(Player player)
		{
			if (player.PetEffects.CurrentUseSkill == m_currentId)
			{
				...
				player.AddPetEffect(new CE1445(1, m_probability, m_type, m_currentId, m_delay, base.ElementInfo.ID.ToString()), 0);
			}
		}
	}
}
