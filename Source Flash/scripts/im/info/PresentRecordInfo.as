package im.info
{
   ...
   public class PresentRecordInfo
   {
      ...
      public function addMessage(param1:String, param2:Date, param3:String) : void
      {
         ...
         {
            _loc5_ = _loc5_ + ("<FONT COLOR=\'#06f710\'>" + param1 + "   " + _loc4_.split(" ")[1] + "</FONT>\n");
         }
         else
         {
            _loc5_ = _loc5_ + ("<FONT COLOR=\'#ffff01\'>" + param1 + "   " + _loc4_.split(" ")[1] + "</FONT>\n");
         }
         ...
         if(param1 == PlayerManager.Instance.Self.NickName)
         {
            _loc6_ = _loc6_ + ("<FONT COLOR=\'#06f710\'>" + param1 + "   " + _loc4_ + "</FONT>\n");
         }
         else
         {
            _loc6_ = _loc6_ + ("<FONT COLOR=\'#ffff01\'>" + param1 + "   " + _loc4_ + "</FONT>\n");
         }
