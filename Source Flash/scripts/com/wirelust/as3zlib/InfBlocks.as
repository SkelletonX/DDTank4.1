package com.wirelust.as3zlib
{
   ...
   public final class InfBlocks
   {
      ...
      public function proc(param1:ZStream, param2:int) : int
      {
         ...
         while(true)
         {
            if(false)
            {
               ...
               param1.total_in = param1.total_in + (_loc6_ - param1.next_in_index);
               ...
               case TYPE:
                  while(_loc5_ < 3)
                  {
                     if(_loc7_ != 0)
                     {
                        ...
                        _loc4_ = _loc4_ | (_loc18_ & 255) << _loc5_;
                        _loc5_ = _loc5_ + 8;
                        continue;
                     }
                     this.bitb = _loc4_;
               ...
               case LENS:
                  while(_loc5_ < 32)
                  {
                     if(_loc7_ != 0)
                     {
                        param2 = Z_OK;
                        _loc7_--;
                        _loc4_ = _loc4_ | (param1.next_in[_loc6_++] & 255) << _loc5_;
                        _loc5_ = _loc5_ + 8;
                        continue;
                     }
                     this.bitb = _loc4_;
               ...
               case DTREE:
                  while(true)
                  {
                     ...
                     else
                     {
                        ...
                        _loc4_ = _loc4_ >>> _loc3_;
                        _loc5_ = _loc5_ - _loc3_;
                        _loc16_ = _loc16_ + (_loc4_ & inflate_mask[_loc15_]);
      ...
      public function inflate_flush(param1:ZStream, param2:int) : int
      {
         ...
         param1.avail_out = param1.avail_out - _loc3_;
         param1.total_out = param1.total_out + _loc3_;
         if(this.checkfn != null)
         {
