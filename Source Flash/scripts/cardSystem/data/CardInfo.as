   ...
   public class CardInfo extends EventDispatcher
   {
      ...
      public function get realAttack() : int
      {
         ...
         if(this.Level != 0)
         {
            ...
            {
               _loc1_ = _loc1_ + CardControl.Instance.model.propIncreaseDic[this.TemplateID][_loc2_].Attack;
               _loc2_++;
            }
      ...
      public function get realDefence() : int
      {
         ...
         if(this.Level != 0)
         {
            ...
            {
               _loc1_ = _loc1_ + _loc2_[_loc3_].Defend;
               _loc3_++;
            }
      ...
      public function get realAgility() : int
      {
         ...
         if(this.Level != 0)
         {
            ...
            while(_loc2_ <= this.Level)
            {
               _loc1_ = _loc1_ + CardControl.Instance.model.propIncreaseDic[this.TemplateID][_loc2_].Agility;
               _loc2_++;
            }
      ...
      public function get realLuck() : int
      {
         ...
         if(this.Level != 0)
         {
            ...
            while(_loc2_ <= this.Level)
            {
               _loc1_ = _loc1_ + CardControl.Instance.model.propIncreaseDic[this.TemplateID][_loc2_].Lucky;
               _loc2_++;
            }
      ...
      public function get realDamage() : int
      {
         ...
         if(this.Level != 0)
         {
            ...
            while(_loc2_ <= this.Level)
            {
               _loc1_ = _loc1_ + CardControl.Instance.model.propIncreaseDic[this.TemplateID][_loc2_].Damage;
               _loc2_++;
            }
      ...
      public function get realGuard() : int
      {
         ...
         if(this.Level != 0)
         {
            ...
            while(_loc2_ <= this.Level)
            {
               _loc1_ = _loc1_ + CardControl.Instance.model.propIncreaseDic[this.TemplateID][_loc2_].Guard;
               _loc2_++;
            }
