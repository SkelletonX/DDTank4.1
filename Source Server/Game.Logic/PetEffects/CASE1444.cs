...
{
    public class CASE1444 : BasePetEffect
    {
        private int int_0;
        private int int_1;
        private int int_2;
        ...
        private int int_4;
        private int int_5;
        public CASE1444(int count, int probability, int type, int skillId, int delay, string elementID) : base(ePetEffectType.CASE1444, elementID)
        {
            this.int_1 = count;
            this.int_3 = count;
        ...
        {
            CASE1444 aE = living.PetEffectList.GetOfType(ePetEffectType.CASE1444) as CASE1444;
            if (aE != null)
            {
        ...
        private void method_0(Living living_0, Living living_1, ref int int_6, ref int int_7)
        {
            ...
            {
                this.int_5 = 500;
                this.int_5 += int_6 * 20 / 100;
                int_6 -= this.int_5;
                this.IsTrigger = false;
                Console.WriteLine("+500 diem giam thuong & 20% diem giam thuong");
            }
        }
