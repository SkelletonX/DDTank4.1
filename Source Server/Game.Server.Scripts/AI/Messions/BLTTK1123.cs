...
namespace GameServerScript.AI.Messions
{
    public class BLTTK1123 : AMissionControl
    {
        ...
        public override void OnStartGame()
        {
            ...
            m_king.Say(LanguageMgr.GetTranslation("GameServer.BLTTAH1123.Msg1"), 0, 300);
        ...
        public void CreateStarGame()
        {
            ...
            boss.Say(LanguageMgr.GetTranslation("GameServer.BLTTAH1123.Msg2"), 0, 1500, 0);
        }
