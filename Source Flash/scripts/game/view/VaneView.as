package game.view
{
   ...
   public class VaneView extends Sprite
   {
      ...
      {
         var _loc1_:Number = Math.random() * RandomVaneOffset - RandomVaneOffset / 2;
         return _loc1_;
      }
      ...
      private function setRandomPos() : void
      {
         ...
         this.vane1_mc.x = this.vane1_mc.x + _loc1_;
         this._windNumShape.x = this._windNumShape.x + _loc1_;
      }
