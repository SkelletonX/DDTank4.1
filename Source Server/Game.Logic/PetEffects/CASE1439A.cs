...
{
    public class CASE1439A : BasePetEffect
    {
        private int int_0;
        private int int_1;
        private int int_2;
        ...
        private int int_5;
        private int int_6;
        public CASE1439A(int count, int probability, int type, int skillId, int delay, string elementID) : base(ePetEffectType.CASE1439A, elementID)
        {
            this.int_1 = count;
            this.int_4 = count;
        ...
        {
            CASE1439A cE = living.PetEffectList.GetOfType(ePetEffectType.CASE1439A) as CASE1439A;
            if (cE != null)
            {
