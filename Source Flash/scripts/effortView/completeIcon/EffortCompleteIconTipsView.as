      ...
      private function update() : void
      {
         ...
         if(this._tipData && this._tipData.effortRewardArray)
         {
            ...
            while(_loc2_ < this._tipData.effortRewardArray.length)
            {
               ...
               {
                  _loc3_.htmlMessage = _loc3_.htmlMessage + LanguageMgr.GetTranslation("tank.view.effort.EffortRigthItemView.honorNameIV");
                  ...
                  _loc3_.htmlMessage = _loc3_.htmlMessage + _loc6_;
                  _loc7_ = "";
                  _loc7_ = _loc7_ + Helpers.deCodeString(_loc3_.htmlMessage);
