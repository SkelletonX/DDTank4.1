package store.view.fusion
{
   ...
   public class StoreIIFusionBG extends Sprite implements IStoreViewBG
   {
      ...
      public function dragDrop(param1:BagCell) : void
      {
         ...
         while(_loc4_ < 5)
         {
            ...
            if(_loc3_ is FusionItemCell)
            {
               ...
               else if(_loc2_.FusionType != 0 && _loc2_.FusionRate != 0)
               {
      ...
      private function __checkAuto() : void
      {
         if(this.autoFusion)
         {
            var auto:Function = function():void
            {
               __fusionClick(null);
            };
      ...
      private function __upPreview(param1:CrazyTankSocketEvent) : void
      {
         ...
         var _loc6_:PreviewInfoII = null;
         var _loc7_:PreviewInfoII = null;
         this.hideArr();
         ...
         while(_loc4_ < _loc3_)
         {
            ...
            this._itemsPreview.push(_loc6_);
            _loc4_++;
         }
         _loc2_ = param1.pkg.readBoolean();
         var _loc5_:int = 0;
         while(_loc5_ < this._itemsPreview.length)
         {
            _loc7_ = this._itemsPreview[_loc5_] as PreviewInfoII;
            _loc7_.info.IsBinds = _loc2_;
            _loc5_++;
         }
         this._showPreview();
         this.showArr();
