...
namespace Game.Service
{
  internal class Program
  {
    ...
    {
      Program.RegisterAction((IAction) new ServiceRun());
      Program.RegisterAction((IAction) new ConsoleStart());
      Program.RegisterAction((IAction) new ServiceInstall());
      Program.RegisterAction((IAction) new ServiceUninstall());
      Program.RegisterAction((IAction) new ServiceStart());
      Program.RegisterAction((IAction) new ServiceStop());
    }
