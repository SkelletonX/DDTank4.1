...
{
    public class CASE1202A : BasePetEffect
    {
        private int int_0;
        private int int_1;
        private int int_2;
        ...
        private int int_5;
        private int int_6;
        public CASE1202A(int count, int probability, int type, int skillId, int delay, string elementID) : base(ePetEffectType.CASE1202A, elementID)
        {
            this.int_1 = count;
            this.int_4 = count;
        ...
        {
            CASE1202A cE = living.PetEffectList.GetOfType(ePetEffectType.CASE1202A) as CASE1202A;
            if (cE != null)
            {
