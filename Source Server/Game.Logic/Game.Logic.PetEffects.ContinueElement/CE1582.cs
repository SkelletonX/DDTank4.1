...
{
	public class CE1582 : BasePetEffect
	{
		...
		public CE1582(int count, int probability, int type, int skillId, int delay, string elementID)
			: base(ePetEffectType.CE1582, elementID)
		{
			m_count = count;
			m_coldDown = count;
		...
		{
			CE1582 cE = living.PetEffectList.GetOfType(ePetEffectType.CE1582) as CE1582;
			if (cE == null)
			{
