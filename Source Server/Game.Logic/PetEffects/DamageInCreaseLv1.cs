...
{
    public class DamageInCreaseLv1 : BasePetEffect
    {
        private int int_0;
        private int int_1;
        private int int_2;
        ...
        private int int_5;
        private int int_6;
        public DamageInCreaseLv1(int count, int probability, int type, int skillId, int delay, string elementID) : base(ePetEffectType.DamageInCreaseLv1, elementID)
        {
            this.int_1 = count;
            this.int_4 = count;
        ...
        {
            DamageInCreaseLv1 aE = living.PetEffectList.GetOfType(ePetEffectType.DamageInCreaseLv1) as DamageInCreaseLv1;
            if (aE != null)
            {
