...
namespace GameServerScript.AI.Messions
{
    public class BLTTAH1124 : AMissionControl
    {
        ...
        public override void OnStartGame()
        {
            ...
            king.Say(LanguageMgr.GetTranslation("GameServer.BLTTT1124.Msg1"), 0, 3300);

            ((PVEGame)Game).SendObjectFocus(boss, 1, 6200, 0);
            boss.PlayMovie("castA", 7000, 0);
            boss.Say(LanguageMgr.GetTranslation("GameServer.BLTTT1124.Msg2"), 0, 7300);
        ...
        {
            if (king != null && king.IsLiving == false && boss != null && boss.IsLiving == false)
            {
                m_kill++;
                return true;
            }
        ...
        public override void OnGameOver()
        {
            ...
            if (king != null && king.IsLiving == false && boss != null && boss.IsLiving == false && IsAllPlayerDie == false)
            {
                Game.IsWin = true;
            }
            else
