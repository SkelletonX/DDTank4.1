package par.particals
{
   ...
   public class Particle
   {
      ...
      public function update(param1:Number) : void
      {
         ...
         this.x = this.x + (_loc4_.x + _loc5_.x) * param1;
         this.y = this.y + (_loc4_.y + _loc5_.y + this.gv) * param1;
         this.scale = _loc3_.easingSize(this.size,_loc2_);
         this.rotation = this.rotation + _loc3_.easingSpinVelocity(this.spin,_loc2_) * param1;
