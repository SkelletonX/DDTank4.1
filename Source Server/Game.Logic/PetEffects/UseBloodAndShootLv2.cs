...
{
    public class UseBloodAndShootLv2 : BasePetEffect
    {
        private int int_0;
        private int int_1;
        private int int_2;
        ...
        private int int_5;
        private int int_6;
        public UseBloodAndShootLv2(int count, int probability, int type, int skillId, int delay, string elementID) : base(ePetEffectType.UseBloodAndShootLv2, elementID)
        {
            this.int_1 = count;
            this.int_4 = count;
        ...
        {
            UseBloodAndShootLv2 pE = living.PetEffectList.GetOfType(ePetEffectType.UseBloodAndShootLv2) as UseBloodAndShootLv2;
            if (pE != null)
            {
        ...
        {
            this.int_6 = player_0.Blood * 3 / 100;
            ...
            foreach (Living current in player_0.Game.Map.FindAllNearestEnemy(player_0.X, player_0.Y, 250.0, player_0))
            {
                ...
                if (current.Blood <= 0)
                {
                    ...
                    if (player_0 != null && player_0 != null)
                    {
                        ...
                        Console.WriteLine("USE 3% BLOOD FOR DAMAGE");
                    }
                }
            }
        }
