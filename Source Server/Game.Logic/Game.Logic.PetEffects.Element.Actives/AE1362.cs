...
namespace Game.Logic.PetEffects.Element.Actives
{
	public class AE1362 : BasePetEffect
	{
		...
		{
			AE1362 aE = living.PetEffectList.GetOfType(ePetEffectType.AE1362) as AE1362;
			if (aE == null)
			{
		...
		private void Player_PlayerBuffSkillPet(Player player)
		{
			if (player.PetEffects.CurrentUseSkill == m_currentId)
			{
				...
				player.AddPetEffect(new CE1362(3, m_probability, m_type, m_currentId, m_delay, base.ElementInfo.ID.ToString()), 0);
			}
		}
