package vip.view
{
   ...
   public class GiveYourselfOpenView extends Sprite implements Disposeable
   {
      ...
      private function getVIPInfoTip(param1:DictionaryData) : Array
      {
         ...
         _loc2_ = PlayerManager.Instance.Self.VIPLevel == 9?[ItemManager.Instance.getTemplateById(int(this._vipChestsArr[PlayerManager.Instance.Self.VIPLevel - 1])),ItemManager.Instance.getTemplateById(int(this._vipChestsArr[PlayerManager.Instance.Self.VIPLevel - 2]))]:[ItemManager.Instance.getTemplateById(int(this._vipChestsArr[PlayerManager.Instance.Self.VIPLevel - 1])),ItemManager.Instance.getTemplateById(int(this._vipChestsArr[PlayerManager.Instance.Self.VIPLevel]))];
         return _loc2_;
      }
