...
{
    public class CASE1209A : BasePetEffect
    {
        private int int_0;
        private int int_1;
        private int int_2;
        ...
        private int int_5;
        private int int_6;
        public CASE1209A(int count, int probability, int type, int skillId, int delay, string elementID) : base(ePetEffectType.CASE1209A, elementID)
        {
            this.int_1 = count;
            this.int_4 = count;
        ...
        {
            CASE1209A cE = living.PetEffectList.GetOfType(ePetEffectType.CASE1209A) as CASE1209A;
            if (cE != null)
            {
