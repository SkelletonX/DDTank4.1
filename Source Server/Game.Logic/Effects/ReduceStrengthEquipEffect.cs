...
namespace Game.Logic.Effects
{
  public class ReduceStrengthEquipEffect : BasePlayerEffect
  {
    ...
    private void ChangeProperty(Player player)
    {
      ...
      player.Game.AddAction((IAction) new LivingSayAction((Living) player, LanguageMgr.GetTranslation("ReduceStrengthEquipEffect.msg"), 9, 0, 1000));
    }
      ...
      int criticalAmount)
    {
      if (!this.IsTrigger)
        return;
      target.AddEffect((AbstractEffect) new ReduceStrengthEffect(2, this.m_count), 0);
    }
