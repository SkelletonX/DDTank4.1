package petsBag.petsAdvanced
{
   ...
   public class PetsEvolutionView extends PetsAdvancedView
   {
      ...
      private function updateData() : void
      {
         ...
         var _loc2_:int = !!_petInfo.IsEquip?int(_petInfo.Blood + this._currentGradeInfo.Blood):int(_petInfo.Blood);
         var _loc3_:int = !!_petInfo.IsEquip?int(_petInfo.Attack + this._currentGradeInfo.Attack):int(_petInfo.Attack);
         var _loc4_:int = !!_petInfo.IsEquip?int(_petInfo.Defence + this._currentGradeInfo.Defence):int(_petInfo.Defence);
         var _loc5_:int = !!_petInfo.IsEquip?int(_petInfo.Agility + this._currentGradeInfo.Agility):int(_petInfo.Agility);
         var _loc6_:int = !!_petInfo.IsEquip?int(_petInfo.Luck + this._currentGradeInfo.Lucky):int(_petInfo.Luck);
