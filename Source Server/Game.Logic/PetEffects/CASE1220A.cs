...
{
    public class CASE1220A : BasePetEffect
    {
        private int int_0;
        private int int_1;
        private int int_2;
        ...
        private int int_5;
        private int int_6;
        public CASE1220A(int count, int probability, int type, int skillId, int delay, string elementID) : base(ePetEffectType.CASE1220A, elementID)
        {
            this.int_1 = count;
            this.int_4 = count;
        ...
        {
            CASE1220A cE = living.PetEffectList.GetOfType(ePetEffectType.CASE1220A) as CASE1220A;
            if (cE != null)
            {
