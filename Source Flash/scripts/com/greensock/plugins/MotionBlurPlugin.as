   ...
   public class MotionBlurPlugin extends TweenPlugin
   {
      ...
      override public function set changeFactor(param1:Number) : void
      {
         ...
         if(!this._fastMode || !this._cached)
         {
            ...
            _loc12_.width = _loc12_.width + this._padding * 2;
            _loc12_.height = _loc12_.height + this._padding * 2;
         ...
         {
            this._matrix.tx = this._matrix.tx - _loc9_;
         ...
         {
            this._matrix.ty = this._matrix.ty - _loc9_;
         ...
         _loc7_ = _loc7_ + this._blur.blurX * 2;
