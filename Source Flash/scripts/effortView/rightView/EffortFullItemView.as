package effortView.rightView
{
   ...
   public class EffortFullItemView extends Sprite implements Disposeable
   {
      ...
      private function init() : void
      {
         ...
         var _loc1_:Point = ComponentFactory.Instance.creatCustomObject("effortView.EffortFullView.EffortIconViewPos_0");
         ...
         var _loc2_:Point = ComponentFactory.Instance.creatCustomObject("effortView.EffortFullView.EffortIconViewPos_1");
