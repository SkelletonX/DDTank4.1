...
{
	public class CE2961 : BasePetEffect
	{
		...
		public CE2961(int count, int probability, int type, int skillId, int delay, string elementID, Living source)
			: base(ePetEffectType.CE2961, elementID)
		{
			m_count = count;
			m_coldDown = count;
		...
		{
			CE2961 cE = living.PetEffectList.GetOfType(ePetEffectType.CE2961) as CE2961;
			if (cE == null)
			{
		...
		private void Player_BeginSelfTurn(Living living)
		{
			...
			m_added = 8 * living.MaxBlood / 100;
			living.AddRemoveEnergy(20);
