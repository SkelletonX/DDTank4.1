package ddt.utils
{
   ...
   public class StaticFormula
   {
      ...
      public static function getDamage(param1:PlayerInfo) : int
      {
         ...
         {
            _loc2_ = _loc2_ + getJewelDamage(param1.Bag.items[0]);
         }
         if(param1.Bag.items[4])
         {
            _loc2_ = _loc2_ + getJewelDamage(param1.Bag.items[4]);
         }
         return _loc2_;
      }
      ...
      public static function getRecovery(param1:PlayerInfo) : int
      {
         ...
         if(_loc3_)
         {
            _loc2_ = _loc2_ + (getDefenseAddition(int(_loc3_.Property7),_loc3_.StrengthenLevel + (!!_loc3_.isGold?1:0)) + int(_loc3_.Property7) + getJewelRecovery(_loc3_));
         }
         _loc3_ = param1.Bag.items[6] as InventoryItemInfo;
         if(_loc3_)
         {
            _loc2_ = _loc2_ + getJewelRecovery(_loc3_);
         }
         return _loc2_;
      }
