...
{
    public class CASE1210A : BasePetEffect
    {
        private int int_0;
        private int int_1;
        private int int_2;
        ...
        private int int_5;
        private int int_6;
        public CASE1210A(int count, int probability, int type, int skillId, int delay, string elementID) : base(ePetEffectType.CASE1210A, elementID)
        {
            this.int_1 = count;
            this.int_4 = count;
        ...
        {
            CASE1210A cE = living.PetEffectList.GetOfType(ePetEffectType.CASE1210A) as CASE1210A;
            if (cE != null)
            {
