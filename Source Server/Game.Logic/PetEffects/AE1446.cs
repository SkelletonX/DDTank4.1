...
namespace Game.Logic.PetEffects.Element.Actives
{
	public class AE1446 : BasePetEffect
	{
		...
		{
			AE1446 aE = living.PetEffectList.GetOfType(ePetEffectType.AE1446) as AE1446;
			if (aE == null)
			{
		...
		private void player_AfterBuffSkillPetByLiving(Player player)
		{
			if (player.PetEffects.CurrentUseSkill == m_currentId)
			{
				...
				player.AddPetEffect(new CE1446(1, m_probability, m_type, m_currentId, m_delay, base.ElementInfo.ID.ToString()), 0);
			}
		}
	}
}
