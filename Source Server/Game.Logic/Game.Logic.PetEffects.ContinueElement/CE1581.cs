...
{
	public class CE1581 : BasePetEffect
	{
		...
		public CE1581(int count, int probability, int type, int skillId, int delay, string elementID)
			: base(ePetEffectType.CE1581, elementID)
		{
			m_count = count;
			m_coldDown = count;
		...
		{
			CE1581 cE = living.PetEffectList.GetOfType(ePetEffectType.CE1581) as CE1581;
			if (cE == null)
			{
