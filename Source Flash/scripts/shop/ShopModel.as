package shop
{
   ...
   public class ShopModel extends EventDispatcher
   {
      ...
      public function updateCost() : void
      {
         ...
         this._totalGold = this._totalGold + _loc1_[0];
         this._totalMoney = this._totalMoney + _loc1_[1];
         this._totalGift = this._totalGift + _loc1_[2];
         this._totalMedal = this._totalMedal + _loc1_[3];
