...
{
    public class CASE1204A : BasePetEffect
    {
        private int int_0;
        private int int_1;
        private int int_2;
        ...
        private int int_5;
        private int int_6;
        public CASE1204A(int count, int probability, int type, int skillId, int delay, string elementID) : base(ePetEffectType.CASE1204A, elementID)
        {
            this.int_1 = count;
            this.int_4 = count;
        ...
        {
            CASE1204A cE = living.PetEffectList.GetOfType(ePetEffectType.CASE1204A) as CASE1204A;
            if (cE != null)
            {
