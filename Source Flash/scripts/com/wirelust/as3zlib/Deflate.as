package com.wirelust.as3zlib
{
   ...
   public class Deflate
   {
      ...
      function scan_tree(param1:Array, param2:int) : void
      {
         ...
         while(_loc3_ <= param2)
         {
            ...
            if(!(++_loc7_ < _loc8_ && _loc5_ == _loc6_))
            {
               if(_loc7_ < _loc9_)
               {
                  this.bl_tree[_loc5_ * 2] = this.bl_tree[_loc5_ * 2] + _loc7_;
               }
               else if(_loc5_ != 0)
               {
                  if(_loc5_ != _loc4_)
      ...
      public function build_bl_tree() : int
      {
         ...
         this.opt_len = this.opt_len + (3 * (_loc1_ + 1) + 5 + 5 + 4);
         return _loc1_;
      }
      ...
      public final function put_byte(param1:ByteArray, param2:int, param3:int) : void
      {
         ...
         this.pending = this.pending + param3;
      }
      ...
      public function send_bits(param1:int, param2:int) : void
      {
         ...
         {
            _loc4_ = param1;
            this.bi_buf = this.bi_buf | _loc4_ << this.bi_valid & 65535;
            ...
            this.bi_valid = this.bi_valid + (_loc3_ - Buf_size);
         }
         else
         {
            this.bi_buf = this.bi_buf | param1 << this.bi_valid & 65535;
            this.bi_valid = this.bi_valid + _loc3_;
         }
      }
      ...
      public function _tr_tally(param1:int, param2:int) : Boolean
      {
         ...
         if((this.last_lit & 1) == 0 && this.level > 2)
         {
            ...
            {
               _loc3_ = _loc3_ + int(this.dyn_dtree[_loc5_ * 2]) * (5 + Tree.extra_dbits[_loc5_]);
               _loc5_++;
            }
            _loc3_ = _loc3_ >>> 3;
         ...
         if(this.last_lit != 0)
         {
            do
            {
               ...
               else
               {
                  ...
                  if(_loc7_ != 0)
                  {
                     _loc4_ = _loc4_ - Tree.base_length[_loc6_];
                  ...
                  if(_loc7_ != 0)
                  {
                     _loc3_ = _loc3_ - Tree.base_dist[_loc6_];
      ...
      function set_data_type() : void
      {
         ...
         while(_loc1_ < 7)
         {
            _loc3_ = _loc3_ + this.dyn_ltree[_loc1_ * 2];
            _loc1_++;
         }
         while(_loc1_ < 128)
         {
            _loc2_ = _loc2_ + this.dyn_ltree[_loc1_ * 2];
            _loc1_++;
         }
      ...
      function fill_window() : void
      {
         ...
         while(true)
         {
            ...
            this.lookahead = this.lookahead + _loc1_;
      ...
      public function deflate(param1:ZStream, param2:int) : int
      {
         ...
         if(this.status == INIT_STATE)
         {
            ...
            _loc4_ = _loc4_ | _loc5_ << 6;
            if(this.strstart != 0)
            {
               _loc4_ = _loc4_ | PRESET_DICT;
            }
            _loc4_ = _loc4_ + (31 - _loc4_ % 31);
