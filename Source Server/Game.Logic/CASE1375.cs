...
{
    public class CASE1375 : BasePetEffect
    {
        private int int_0;
        private int int_1;
        private int int_2;
        ...
        private int int_5;
        private int int_6;
        public CASE1375(int count, int probability, int type, int skillId, int delay, string elementID) : base(ePetEffectType.CASE1375, elementID)
        {
            this.int_1 = count;
            this.int_4 = count;
        ...
        {
            CASE1375 aE = living.PetEffectList.GetOfType(ePetEffectType.CASE1375) as CASE1375;
            if (aE != null)
            {
