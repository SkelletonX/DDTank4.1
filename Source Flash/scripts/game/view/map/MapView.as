package game.view.map
{
   ...
   public class MapView extends Map
   {
      ...
      private function getTwoHundredDisPoint(param1:Number, param2:Number, param3:Number, param4:Number, param5:int) : Point
      {
         ...
         {
            _loc8_ = findYLineNotEmptyPointDown(param1 + 200 * param5,param2,this.bound.height);
            return _loc8_;
         }
         param5 = param5 * -1;
         _loc6_ = param1 + 200 * param5 + param3 * param5;
         var _loc7_:Point = findYLineNotEmptyPointDown(param1 + 200 * param5,param2,this.bound.height);
         return _loc7_;
      }
