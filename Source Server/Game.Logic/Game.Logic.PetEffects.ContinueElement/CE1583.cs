...
{
	public class CE1583 : BasePetEffect
	{
		...
		public CE1583(int count, int probability, int type, int skillId, int delay, string elementID)
			: base(ePetEffectType.CE1583, elementID)
		{
			m_count = count;
			m_coldDown = count;
		...
		{
			CE1583 cE = living.PetEffectList.GetOfType(ePetEffectType.CE1583) as CE1583;
			if (cE == null)
			{
