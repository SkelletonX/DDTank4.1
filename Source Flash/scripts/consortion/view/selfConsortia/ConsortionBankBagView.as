package consortion.view.selfConsortia
{
   ...
   public class ConsortionBankBagView extends BagView
   {
      ...
      override protected function set_text_location() : void
      {
         if(_goldText)
         {
            _goldText.y = _goldText.y + 31;
         }
         if(_moneyText)
         {
            _moneyText.y = _moneyText.y + 31;
         }
         if(_giftText)
         {
            _giftText.y = _giftText.y + 31;
         }
         if(_medalField)
         {
            _medalField.y = _medalField.y + 31;
         }
      }
      
      override protected function set_btn_location() : void
      {
         _goldButton.y = _goldButton.y + 32;
         _giftButton.y = _giftButton.y + 32;
         _moneyButton.y = _moneyButton.y + 32;
         _medalButton.y = _medalButton.y + 32;
         _sellBtn.y = _sellBtn.y + 32;
         _continueBtn.y = _continueBtn.y + 32;
         _breakBtn.y = _breakBtn.y + 32;
         _keySetBtn.y = _keySetBtn.y + 32;
      }
      ...
      override protected function initBagList() : void
      {
         ...
         _proplist = new BagEquipListView(1,0,49);
