...
{
    public class CASE1152A : BasePetEffect
    {
        private int int_0;
        private int int_1;
        private int int_2;
        ...
        public CASE1152A(int count, int probability, int type, int skillId, int delay, string elementID, Living source) : base(ePetEffectType.CASE1152A, elementID)
        {
            this.int_1 = count;
            this.int_4 = count;
        ...
        {
            CASE1152A cE = living.PetEffectList.GetOfType(ePetEffectType.CASE1152A) as CASE1152A;
            if (cE != null)
            {
        ...
        private void method_2(Living living_1)
        {
            ...
            this.int_6 = living_1.MaxBlood * 30 / 10 / 100;
