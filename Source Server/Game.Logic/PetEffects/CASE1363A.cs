...
{
    public class CASE1363A : BasePetEffect
    {
        private int int_0;
        private int int_1;
        private int int_2;
        ...
        private int int_5;
        private int int_6;
        public CASE1363A(int count, int probability, int type, int skillId, int delay, string elementID) : base(ePetEffectType.CASE1363A, elementID)
        {
            this.int_1 = count;
            this.int_4 = count;
        ...
        {
            CASE1363A cE = living.PetEffectList.GetOfType(ePetEffectType.CASE1363A) as CASE1363A;
            if (cE != null)
            {
