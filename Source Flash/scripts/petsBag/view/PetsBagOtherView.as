package petsBag.view
{
   ...
   public class PetsBagOtherView extends PetsBagView
   {
      ...
      override public function updatePetsPropByEvolution() : void
      {
         ...
         if(_loc1_)
         {
            _attackPbtn.propValue = !!_loc1_.IsEquip?int(_loc1_.Attack + _currentGradeInfo.Attack):int(_loc1_.Attack);
            _defencePbtn.propValue = !!_loc1_.IsEquip?int(_loc1_.Defence + _currentGradeInfo.Defence):int(_loc1_.Defence);
            _HPPbtn.propValue = !!_loc1_.IsEquip?int(_loc1_.Blood + _currentGradeInfo.Blood):int(_loc1_.Blood);
            _agilityPbtn.propValue = !!_loc1_.IsEquip?int(_loc1_.Agility + _currentGradeInfo.Agility):int(_loc1_.Agility);
            _luckPbtn.propValue = !!_loc1_.IsEquip?int(_loc1_.Luck + _currentGradeInfo.Lucky):int(_loc1_.Luck);
         }
      }
