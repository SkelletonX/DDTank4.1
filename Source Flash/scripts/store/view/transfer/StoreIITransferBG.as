   ...
   public class StoreIITransferBG extends Sprite implements IStoreViewBG
   {
      ...
      private function __itemInfoChange(param1:Event) : void
      {
         ...
         if(_loc2_.info && _loc3_.info)
         {
            ...
            if(this.isComposeStrengthen(_loc2_) || this.isOpenHole(_loc2_) || this.isHasBead(_loc2_) || this.isComposeStrengthen(_loc3_) || this.isOpenHole(_loc3_) || this.isHasBead(_loc3_))
            {
               this.showArr();
               this.goldMoney();
            }
      ...
      private function _showDontClickTip() : Boolean
      {
         ...
         if(!this.isComposeStrengthen(_loc1_) && !this.isOpenHole(_loc1_) && !this.isHasBead(_loc1_) && !this.isComposeStrengthen(_loc2_) && !this.isOpenHole(_loc2_) && !this.isHasBead(_loc2_))
         {
