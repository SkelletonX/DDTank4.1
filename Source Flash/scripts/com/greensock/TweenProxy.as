package com.greensock
{
   ...
   public dynamic class TweenProxy extends Proxy
   {
      ...
      {
         this._registration.x = this._registration.x + param1;
      }
      
      public function moveRegY(param1:Number) : void
      {
         this._registration.y = this._registration.y + param1;
      }
      ...
      private function reposition() : void
      {
         ...
         this._target.x = this._target.x + (this._registration.x - _loc1_.x);
         this._target.y = this._target.y + (this._registration.y - _loc1_.y);
      }
      ...
      public function set x(param1:Number) : void
      {
         ...
         this._target.x = this._target.x + _loc2_;
      ...
      public function set y(param1:Number) : void
      {
         ...
         this._target.y = this._target.y + _loc2_;
         var _loc3_:int = this._proxies.length - 1;
         while(_loc3_ > -1)
         {
            if(this._proxies[_loc3_] == this || !this._proxies[_loc3_].ignoreSiblingUpdates)
