...
{
    public class CASE1446A : BasePetEffect
    {
        private int int_0;
        private int int_1;
        private int int_2;
        ...
        private int int_5;
        private int int_6;
        public CASE1446A(int count, int probability, int type, int skillId, int delay, string elementID) : base(ePetEffectType.CASE1446A, elementID)
        {
            this.int_1 = count;
            this.int_4 = count;
        ...
        {
            CASE1446A cE = living.PetEffectList.GetOfType(ePetEffectType.CASE1446A) as CASE1446A;
            if (cE != null)
            {
