...
{
    public class CASE1440A : BasePetEffect
    {
        private int int_0;
        private int int_1;
        private int int_2;
        ...
        private int int_5;
        private int int_6;
        public CASE1440A(int count, int probability, int type, int skillId, int delay, string elementID) : base(ePetEffectType.CASE1440A, elementID)
        {
            this.int_1 = count;
            this.int_4 = count;
        ...
        {
            CASE1440A cE = living.PetEffectList.GetOfType(ePetEffectType.CASE1440A) as CASE1440A;
            if (cE != null)
            {
