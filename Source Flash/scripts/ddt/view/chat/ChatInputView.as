package ddt.view.chat
{
   ...
   public class ChatInputView extends Sprite
   {
      ...
      public function set enableGameState(param1:Boolean) : void
      {
         if(param1)
         {
            this._facePanelPos.x = this._facePanelPos.x - 23;
      ...
      private function checkCanSendTime() : Boolean
      {
         ...
         {
            if((ChatManager.Instance.state == ChatManager.CHAT_WEDDINGLIST_STATE || ChatManager.Instance.state == ChatManager.CHAT_DUNGEONLIST_STATE || ChatManager.Instance.state == ChatManager.CHAT_ROOMLIST_STATE || ChatManager.Instance.state == ChatManager.CHAT_HALL_STATE || ChatManager.Instance.state == ChatManager.CHAT_CONSORTIA_CHAT_VIEW || ChatManager.Instance.state == ChatManager.CHAT_CLUB_STATE || ChatManager.Instance.state == ChatManager.CHAT_CIVIL_VIEW || ChatManager.Instance.state == ChatManager.CHAT_TOFFLIST_VIEW || ChatManager.Instance.state == ChatManager.CHAT_ACADEMY_VIEW || ChatManager.Instance.state == ChatManager.CHAT_HOTSPRING_VIEW || ChatManager.Instance.state == ChatManager.CHAT_LITTLEHALL) && this._channel == CURRENT)
            {
