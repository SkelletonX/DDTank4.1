...
{
	public class CE1589 : BasePetEffect
	{
		...
		public CE1589(int count, int probability, int type, int skillId, int delay, string elementID)
			: base(ePetEffectType.CE1589, elementID)
		{
			m_count = count;
			m_coldDown = count;
		...
		{
			CE1589 cE = living.PetEffectList.GetOfType(ePetEffectType.CE1589) as CE1589;
			if (cE == null)
			{
