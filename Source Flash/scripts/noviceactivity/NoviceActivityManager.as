package noviceactivity
{
   ...
   public class NoviceActivityManager extends EventDispatcher
   {
      ...
      private function __updateNovice(param1:CrazyTankSocketEvent) : void
      {
         ...
         switch(_loc2_.readInt())
         {
            case 0:
               ...
               this.endDate.date = this.endDate.date - 1;
      ...
      public function removeIcon() : void
      {
         if(this._icon)
         {
            this._icon.removeEventListener(MouseEvent.CLICK,this.__showNoviceActivityFrame);
      ...
      private function showNoviceActivityIcon() : void
      {
         ...
         this._icon.addEventListener(MouseEvent.CLICK,this.__showNoviceActivityFrame);
      }
      
      private function __showNoviceActivityFrame(param1:MouseEvent) : void
      {
      ...
      private function loadNoviceActivityModule(param1:Function = null, param2:Array = null) : void
      {
         this._func = param1;
