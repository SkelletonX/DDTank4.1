package store.view.strength
{
   ...
   public class StoreIIStrengthBG extends Sprite implements IStoreViewBG
   {
      ...
      private function getCountRate() : Number
      {
         ...
         if(this._items[0].info != null)
         {
            _loc1_ = _loc1_ + this.rateItems[this._items[0].info.Level - 1];
         }
         if(this._items[1].info != null)
         {
            _loc1_ = _loc1_ + this.rateItems[this._items[1].info.Level - 1];
         }
         if(this._items[2].info != null)
         {
            _loc1_ = _loc1_ + this.rateItems[this._items[2].info.Level - 1];
         }
         if(this._items[4].info != null)
         {
            _loc1_ = _loc1_ + _loc1_ * this._items[4].info.Property2 / 100;
         }
         _loc1_ = _loc1_ * 100 / this.getNeedRate();
         _loc1_ = _loc1_ * (1 + 0.1 * ConsortiaRateManager.instance.rate);
      ...
      private function getCountRateI() : void
      {
         ...
         if(this._items[4].info != null)
         {
            _loc2_ = _loc2_ + _loc1_ * this._items[4].info.Property2 / 100;
         }
         _loc1_ = _loc1_ * 100 / this.getNeedRate();
         ...
         _loc5_ = _loc5_ > 100?Number(100):Number(_loc5_);
