...
{
	public class CE1588 : BasePetEffect
	{
		...
		public CE1588(int count, int probability, int type, int skillId, int delay, string elementID)
			: base(ePetEffectType.CE1588, elementID)
		{
			m_count = count;
			m_coldDown = count;
		...
		{
			CE1588 cE = living.PetEffectList.GetOfType(ePetEffectType.CE1588) as CE1588;
			if (cE == null)
			{
