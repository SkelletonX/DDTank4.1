   ...
   final class InfCodes
   {
      ...
      public function inflate_fast(param1:int, param2:int, param3:Array, param4:int, param5:Array, param6:int, param7:InfBlocks, param8:ZStream) : int
      {
         ...
         do
         {
            ...
            {
               _loc16_--;
               _loc13_ = _loc13_ | (param8.next_in[_loc15_++] & 255) << _loc14_;
               _loc14_ = _loc14_ + 8;
            }
            ...
            {
               _loc13_ = _loc13_ >> _loc10_[_loc24_ + 1];
               _loc14_ = _loc14_ - _loc10_[_loc24_ + 1];
               ...
               while(true)
               {
                  ...
                  if((_loc12_ & 16) != 0)
                  {
                     ...
                     while(true)
                     {
                        ...
                        if((_loc12_ & 64) == 0)
                        {
                           _loc9_ = _loc9_ + _loc10_[_loc24_ + 2];
                           _loc9_ = _loc9_ + (_loc13_ & inflate_mask[_loc12_]);
                           _loc24_ = (_loc11_ + _loc9_) * 3;
                           _loc12_ = _loc10_[_loc24_];
                           if(false)
                           {
                        ...
                        _loc14_ = _loc14_ - (_loc21_ << 3);
                        param7.bitb = _loc13_;
                        param7.bitk = _loc14_;
                        param8.avail_in = _loc16_;
                        param8.total_in = param8.total_in + (_loc15_ - param8.next_in_index);
      ...
      function proc(param1:InfBlocks, param2:ZStream, param3:int) : int
      {
         ...
         while(true)
         {
            if(false)
            {
               ...
               param2.total_in = param2.total_in + (_loc10_ - param2.next_in_index);
            ...
            switch(this.mode)
            {
               ...
               case LEN:
                  ...
                  while(_loc9_ < _loc4_)
                  {
                     if(_loc11_ != 0)
                     {
                        param3 = Z_OK;
                        _loc11_--;
                        _loc8_ = _loc8_ | (param2.next_in[_loc10_++] & 255) << _loc9_;
                        _loc9_ = _loc9_ + 8;
                        continue;
                     }
                     param1.bitb = _loc8_;
                  ...
                  _loc8_ = _loc8_ >>> this.tree[_loc6_ + 1];
                  _loc9_ = _loc9_ - this.tree[_loc6_ + 1];
               ...
               case LENEXT:
                  ...
                  this.len = this.len + (_loc8_ & inflate_mask[_loc4_]);
               ...
               case DISTEXT:
                  ...
                  this.dist = this.dist + (_loc8_ & inflate_mask[_loc4_]);
                  _loc8_ = _loc8_ >> _loc4_;
                  _loc9_ = _loc9_ - _loc4_;
                  this.mode = COPY;
               case COPY:
