package hotSpring.view
{
   ...
   public class HotSpringRoomView extends Sprite
   {
      ...
      protected function initialize() : void
      {
         ...
         this._roomMenuView = new RoomMenuView(this._controller,this._model);
         var _loc1_:Point = ComponentFactory.Instance.creatCustomObject("asset.hotSpring.RoomMenuViewPos");
      ...
      private function roomTimeUp(param1:int, param2:Boolean = false) : void
      {
         ...
         this._sysDateTime.seconds = this._sysDateTime.seconds + 60;
         this.sysDateTimeScene(this._sysDateTime);
      }
      ...
      private function dayAndNight() : void
      {
         ...
         if(this._sysDateTime >= this._dayStart && this._sysDateTime <= this._dayEnd)
         {
            ...
            this._playerLayer.house.dayHouse.y = this._playerLayer.house.dayHouse.y - 1;
            this._playerLayer.house.nightHouse.y = this._playerLayer.house.nightHouse.y + 1;
            if(this._playerLayer.house.dayHouse && !this._playerLayer.house.contains(this._playerLayer.house.dayHouse))
            {
               this._playerLayer.house.addChild(this._playerLayer.house.dayHouse);
            }
            ...
            _loc3_ = Number((_loc2_ / _loc1_ * 100).toFixed(2));
      ...
      private function setPlayerShowItem() : void
      {
         ...
         while(_loc1_ < this._playerLayer.numChildren)
         {
            ...
            if(_loc2_)
            {
               ...
               _loc2_.visible = _loc2_.playerVO.playerInfo.ID != PlayerManager.Instance.Self.ID?Boolean(this._isShowPalyer):Boolean(true);
            }
            _loc1_++;
         }
      }
