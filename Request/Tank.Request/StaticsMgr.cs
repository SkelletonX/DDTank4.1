...
namespace Tank.Request
{
    public static class StaticsMgr
    {
        ...
        public static void Setup()
        {
            ...
            pid = int.Parse(ConfigurationSettings.AppSettings["PID"]);
            did = int.Parse(ConfigurationSettings.AppSettings["DID"]);
            sid = int.Parse(ConfigurationSettings.AppSettings["SID"]);
            _path = ConfigurationSettings.AppSettings["LogPath"];
            _interval = int.Parse(ConfigurationSettings.AppSettings["LogInterval"]) * 60 * 1000;
