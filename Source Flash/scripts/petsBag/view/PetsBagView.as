package petsBag.view
{
   ...
   public class PetsBagView extends Sprite implements Disposeable
   {
      ...
      public function updatePetsPropByEvolution() : void
      {
         ...
         if(_loc1_)
         {
            this._attackPbtn.propValue = !!_loc1_.IsEquip?int(_loc1_.Attack + this._currentGradeInfo.Attack):int(_loc1_.Attack);
            this._defencePbtn.propValue = !!_loc1_.IsEquip?int(_loc1_.Defence + this._currentGradeInfo.Defence):int(_loc1_.Defence);
            this._HPPbtn.propValue = !!_loc1_.IsEquip?int(_loc1_.Blood + this._currentGradeInfo.Blood):int(_loc1_.Blood);
            this._agilityPbtn.propValue = !!_loc1_.IsEquip?int(_loc1_.Agility + this._currentGradeInfo.Agility):int(_loc1_.Agility);
            this._luckPbtn.propValue = !!_loc1_.IsEquip?int(_loc1_.Luck + this._currentGradeInfo.Lucky):int(_loc1_.Luck);
         }
      }
