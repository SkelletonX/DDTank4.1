...
namespace Game.Logic.PetEffects.Element.Actives
{
	public class AE1552 : BasePetEffect
	{
		...
		{
			AE1552 aE = living.PetEffectList.GetOfType(ePetEffectType.AE1552) as AE1552;
			if (aE == null)
			{
		...
		private void Player_Skip(Player player)
		{
			...
			new CE1552(2, m_probability, m_type, m_currentId, m_delay, base.ElementInfo.ID.ToString()).Start(player);
		}
