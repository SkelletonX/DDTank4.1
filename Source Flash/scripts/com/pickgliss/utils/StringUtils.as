   ...
   public final class StringUtils
   {
      ...
      public static function base64Encode(param1:String) : String
      {
         ...
         while(_loc3_ < _loc4_)
         {
            ...
            if(_loc3_ == _loc4_)
            {
               _loc2_ = _loc2_ + (BASE64.charAt(_loc5_ >> 2) + BASE64.charAt((_loc5_ & 3) << 4) + "==");
               break;
            }
            _loc6_ = param1.charCodeAt(_loc3_++);
            if(_loc3_ == _loc4_)
            {
               _loc2_ = _loc2_ + (BASE64.charAt(_loc5_ >> 2) + BASE64.charAt((_loc5_ & 3) << 4 | (_loc6_ & 240) >> 4) + "=");
               break;
            }
            _loc7_ = param1.charCodeAt(_loc3_++);
            _loc2_ = _loc2_ + (BASE64.charAt(_loc5_ >> 2) + BASE64.charAt((_loc5_ & 3) << 4 | (_loc6_ & 240) >> 4) + BASE64.charAt((_loc6_ & 15) << 2 | (_loc7_ & 192) >> 6) + BASE64.charAt(_loc7_ & 63));
         }
         return _loc2_;
      }
      ...
      public static function relativePath(param1:String, param2:String, param3:String = "/") : String
      {
         ...
         {
            _loc11_ = _loc11_ + param3;
            _loc11_ = _loc11_ + _loc7_[_loc10_];
            _loc10_++;
         }
         return _loc11_;
      }
