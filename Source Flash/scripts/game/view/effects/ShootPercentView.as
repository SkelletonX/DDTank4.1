   ...
   public class ShootPercentView extends Sprite
   {
      ...
      private function doShowType1() : void
      {
         ...
         if(this._picBmp.alpha < 1)
         {
            if(this.add)
            {
               this._picBmp.y = this._picBmp.y - 8;
               this._picBmp.alpha = this._picBmp.alpha + 0.22;
            }
            else
            {
               this._picBmp.y = this._picBmp.y - 6;
               this._picBmp.alpha = this._picBmp.alpha - 0.1;
            }
         }
      ...
      private function doShowType2() : void
      {
         ...
         if(this._picBmp.alpha < 1)
         {
            if(this.add)
            {
               ...
               this._picBmp.alpha = this._picBmp.alpha + 0.4;
            }
            else
            {
               this._picBmp.scaleX = this._picBmp.scaleY = this._picBmp.scaleY + 0.125;
               this._picBmp.alpha = this._picBmp.alpha - 0.15;
            }
      ...
      public function getPercent(param1:int) : Bitmap
      {
         ...
         var _loc7_:int = !!this._isAdd?int(1):int(0);
         while(_loc7_ < _loc5_)
         {
            if(this._isAdd)
            {
