...
{
    public class InCreaseDefenceLv1A : BasePetEffect
    {
        private int int_0;
        private int int_1;
        private int int_2;
        ...
        private int int_5;
        private int int_6;
        public InCreaseDefenceLv1A(int count, int probability, int type, int skillId, int delay, string elementID) : base(ePetEffectType.InCreaseDefenceLv1A, elementID)
        {
            this.int_1 = count;
            this.int_4 = count;
        ...
        {
            InCreaseDefenceLv1A cE = living.PetEffectList.GetOfType(ePetEffectType.InCreaseDefenceLv1A) as InCreaseDefenceLv1A;
            if (cE != null)
            {
