package store.view.exalt
{
   ...
   public class StoreExaltBG extends Sprite implements IStoreViewBG
   {
      ...
      protected function __exaltFail(param1:StoreIIEvent) : void
      {
         ...
         var _loc3_:int = this._luckyText.height;
         var _loc4_:int = this._luckyText.y;
         this._luckyText.width = this._luckyText.width / 2;
         this._luckyText.height = this._luckyText.height / 2;
