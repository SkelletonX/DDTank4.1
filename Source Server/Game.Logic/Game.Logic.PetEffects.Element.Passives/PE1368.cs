...
namespace Game.Logic.PetEffects.Element.Passives
{
	public class PE1368 : BasePetEffect
	{
		...
		{
			PE1368 pE = living.PetEffectList.GetOfType(ePetEffectType.PE1368) as PE1368;
			if (pE == null)
			{
		...
		private void Player_BeginNextTurn(Living living)
		{
			if (!IsTrigger)
			{
				...
				{
					allTeamPlayer.AddPetEffect(new CE1368(0, m_probability, m_type, m_currentId, m_delay, base.ElementInfo.ID.ToString()), 0);
				}
				IsTrigger = true;
			}
		}
