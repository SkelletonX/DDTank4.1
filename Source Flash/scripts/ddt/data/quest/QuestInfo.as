package ddt.data.quest
{
   ...
   public class QuestInfo
   {
      ...
      public function get questProgressNum() : Number
      {
         ...
         while(this._conditions[_loc3_])
         {
            _loc1_ = _loc1_ + this.progress[_loc3_];
            _loc2_ = _loc2_ + this._conditions[_loc3_].target;
            _loc3_++;
         }
      ...
      public function get canViewWithProgress() : Boolean
      {
         ...
         {
            _loc2_ = _loc2_ + this.progress[_loc4_];
            _loc3_ = _loc3_ + this._conditions[_loc4_].target;
            _loc4_++;
         }
         if(_loc2_ == _loc3_)
         {
