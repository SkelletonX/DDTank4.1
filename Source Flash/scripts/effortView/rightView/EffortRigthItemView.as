package effortView.rightView
{
   ...
   public class EffortRigthItemView extends Sprite implements Disposeable, IListCell
   {
      ...
      protected function init() : void
      {
         ...
         var _loc1_:Point = ComponentFactory.Instance.creatCustomObject("effortView.EffortRigthItemView.achievementPointViewPos");
      ...
      private function __onTextClicked(param1:TextEvent) : void
      {
         ...
         if(int(_loc2_.clicktype) == ChatFormats.CLICK_GOODS)
         {
            ...
            _loc7_.BindType = _loc2_.isBind == "true"?int(0):int(1);
      ...
      protected function honorName() : void
      {
         ...
         if(this._info && this._info.effortRewardArray)
         {
            ...
            while(_loc2_ < this._info.effortRewardArray.length)
            {
               ...
               {
                  _loc1_.htmlMessage = _loc1_.htmlMessage + LanguageMgr.GetTranslation("tank.view.effort.EffortRigthItemView.honorNameIII");
                  ...
                  _loc1_.htmlMessage = _loc1_.htmlMessage + _loc6_;
               }
               _loc2_++;
            }
            _loc3_ = "";
            _loc3_ = _loc3_ + Helpers.deCodeString(_loc1_.htmlMessage);
