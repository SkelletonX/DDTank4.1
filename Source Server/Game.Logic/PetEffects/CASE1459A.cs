...
{
    public class CASE1459A : BasePetEffect
    {
        private int int_0;
        private int int_1;
        private int int_2;
        ...
        private int int_5;
        private int int_6;
        public CASE1459A(int count, int probability, int type, int skillId, int delay, string elementID) : base(ePetEffectType.CASE1459A, elementID)
        {
            this.int_1 = count;
            this.int_4 = count;
        ...
        {
            CASE1459A cE = living.PetEffectList.GetOfType(ePetEffectType.CASE1459A) as CASE1459A;
            if (cE != null)
            {
