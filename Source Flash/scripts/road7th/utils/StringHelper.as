package road7th.utils
{
   ...
   public class StringHelper
   {
      ...
      public static function pathToString(param1:Array) : String
      {
         ...
         while(_loc3_ < param1.length)
         {
            _loc2_ = _loc2_ + String.fromCharCode(Math.round(param1[_loc3_].x + OFFSET));
            _loc2_ = _loc2_ + String.fromCharCode(Math.round(param1[_loc3_].y + OFFSET));
            _loc3_++;
         }
         return _loc2_;
      }
      ...
      {
         var _loc2_:String = "";
         _loc2_ = _loc2_ + String.fromCharCode(Math.round(param1.x + OFFSET));
         _loc2_ = _loc2_ + String.fromCharCode(Math.round(param1.y + OFFSET));
         return _loc2_;
      }
      ...
      public static function parseTime(param1:String, param2:uint) : String
      {
         ...
         _loc3_ = String(_loc5_.getUTCFullYear()) + "-" + (_loc5_.getUTCMonth() + 1) + "-" + _loc5_.getUTCDate();
         return _loc3_;
      }
