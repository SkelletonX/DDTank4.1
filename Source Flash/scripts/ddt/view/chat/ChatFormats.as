package ddt.view.chat
{
   ...
   public class ChatFormats
   {
      ...
      public static const BIG_BUGGLE_TYPE_STRING:Array = ["sentimientos Amor","Birthday Wishes","Eres el unico","loco bomba","seres Arrogancia"];
      ...
      private static function creatContentTag(param1:ChatData) : String
      {
         ...
         if(param1.link)
         {
            ...
            for each(_loc4_ in param1.link)
            {
               ...
               _loc3_ = _loc3_ + _loc10_.length;
            }
         }
         if(param1.type == CLICK_EFFORT)
         {
            return _loc2_ = creatBracketsTag(_loc2_,CLICK_EFFORT,null,param1);
         }
         if(param1.channel <= 5)
         {
            if(param1.type == CLICK_USERNAME || param1.type == CLICK_DIFF_ZONE)
            {
               return _loc2_ = creatBracketsTag(_loc2_,CLICK_USERNAME,null,param1);
            }
            return _loc2_;
         }
         return _loc2_ = creatBracketsTag(_loc2_,CLICK_USERNAME,null,param1);
