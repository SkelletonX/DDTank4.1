package ddt.data.goods
{
   ...
   public class ItemPrice
   {
      ...
      public function addPrice(param1:Price) : void
      {
         ...
         {
            this._prices[param1.UnitToString] = this._prices[param1.UnitToString] + param1.Value;
         }
      }
      ...
      public function toString() : String
      {
         ...
         if(this.moneyValue > 0)
         {
            _loc1_ = _loc1_ + (this.moneyValue.toString() + Price.MONEYTOSTRING);
         }
         if(this.goldValue > 0)
         {
            _loc1_ = _loc1_ + (this.goldValue.toString() + Price.GOLDTOSTRING);
         }
         if(this.gesteValue > 0)
         {
            _loc1_ = _loc1_ + (this.gesteValue.toString() + Price.GESTETOSTRING);
         }
         if(this.giftValue > 0)
         {
            _loc1_ = _loc1_ + (this.giftValue.toString() + Price.GIFTTOSTRING);
         }
         for(_loc2_ in this._prices)
         {
            if(_loc2_ != Price.MONEYTOSTRING && _loc2_ != Price.GOLDTOSTRING && _loc2_ != Price.GESTETOSTRING && _loc2_ != Price.GIFTTOSTRING)
            {
               _loc1_ = _loc1_ + (this._prices[_loc2_].toString() + _loc2_);
            }
         }
         return _loc1_;
      }
