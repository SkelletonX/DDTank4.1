...
{
    public class CASE1136A : BasePetEffect
    {
        private int int_0;
        private int int_1;
        private int int_2;
        ...
        private int int_5;
        private int int_6;
        public CASE1136A(int count, int probability, int type, int skillId, int delay, string elementID) : base(ePetEffectType.CASE1136A, elementID)
        {
            this.int_1 = count;
            this.int_4 = count;
        ...
        {
            CASE1136A cE = living.PetEffectList.GetOfType(ePetEffectType.CASE1136A) as CASE1136A;
            if (cE != null)
            {
