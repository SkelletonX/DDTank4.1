...
namespace Game.Base.Packets
{
    public interface IPacketLib
    {
        ...
        GSPacketIn SendPetInfo(int id, int zoneId, UsersPetInfo[] pets, EatPetsInfo eatpet);//#5 For EatPets

        GSPacketIn SendUpdateUserPet(PetInventory bag, int[] slots);

        GSPacketIn SendEatPetsInfo(EatPetsInfo info); //#4 For EatPets
        ...
        GSPacketIn SendUserEquip(PlayerInfo player, List<SqlDataProvider.Data.ItemInfo> items, List<SqlDataProvider.Data.UserGemStone> UserGemStone);
        ...
        GSPacketIn SendUserEquip(PlayerInfo player, List<ItemInfo> items);
