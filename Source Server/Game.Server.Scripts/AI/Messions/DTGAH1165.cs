...
namespace GameServerScript.AI.Messions
{
    public class DTGAH1165 : AMissionControl
    {
        ...
        {
            int re1 = Game.Random.Next(-6, 6);
            int re2 = Game.Random.Next(-6, 6);
            int re3 = Game.Random.Next(-6, 6);
            int re4 = Game.Random.Next(-6, 6);
            int re5 = Game.Random.Next(-6, 6);
            int re6 = Game.Random.Next(-6, 6);

            int ad1 = Game.Random.Next(-6, 6);
            int ad2 = Game.Random.Next(-6, 6);
            int ad3 = Game.Random.Next(-6, 6);
            int ad4 = Game.Random.Next(-6, 6);
            int ad5 = Game.Random.Next(-6, 6);
