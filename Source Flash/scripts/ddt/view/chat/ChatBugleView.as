   ...
   public class ChatBugleView extends Sprite
   {
      ...
      private function __onAddChat(param1:ChatEvent) : void
      {
         ...
         if(_loc2_.link)
         {
            ...
            for each(_loc8_ in _loc2_.link)
            {
               ...
               _loc7_ = _loc7_ + _loc11_.Name.length;
            }
         }
         ...
         else if(_loc2_.channel == ChatInputView.SYS_NOTICE || _loc2_.channel == ChatInputView.SYS_TIP)
         {
      ...
      private function __scrollTimer(param1:TimerEvent) : void
      {
         ...
         else if(this._contentTxt.text != "")
         {
            if(_loc2_)
            {
               this._fieldRect.x = this._fieldRect.x + MOVE_STEP;
            }
            else
            {
               this._isplaying = false;
      ...
      public function updatePos() : void
      {
         ...
         else if(StateManager.currentStateType == StateType.LITTLEGAME)
         {
            x = 45;
         }
         else
