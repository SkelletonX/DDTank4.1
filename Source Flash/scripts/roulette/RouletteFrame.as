package roulette
{
   ...
   public class RouletteFrame extends Sprite implements Disposeable
   {
      ...
      private function _timeComplete(param1:TimerEvent) : void
      {
         ...
         this.nowDelayTime = this.nowDelayTime + this._stepTime;
         this.nextNode();
      ...
      private function nextNode() : void
      {
         if(!this._isStopTurn)
         {
            this.sparkleNumber = this.sparkleNumber + 1;
      ...
      {
         this._turnTypeTimeSum = this._turnTypeTimeSum + this._nowDelayTime;
      ...
      public function set selectedGoodsNumber(param1:int) : void
      {
         ...
         while(_loc2_ < 0)
         {
            _loc2_ = _loc2_ + this._goodsList.length;
         }
      ...
      private function get prevSelected() : int
      {
         ...
         switch(this._turnType)
         {
            ...
            case TYPE_SPEED_DOWN:
               ...
               {
                  _loc2_ = this._moderationNumber >= 3?int(this._moderationNumber - 2):int(1);
