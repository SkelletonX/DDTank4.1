package quest
{
   ...
   public class QuestRewardView extends Sprite implements Disposeable
   {
      ...
      private function update() : void
      {
         ...
         this._itemAwardPosY = this._itemAwardPosY + Math.ceil(_loc2_ / 4) * this.ROW_HEIGHT;
         if(this._info.RewardBuffID != 0)
         {
            ...
            this._itemAwardPosY = this._itemAwardPosY + this.ROW_HEIGHT;
            ...
            {
               _loc4_ = _loc4_ * this._info.data.quality;
            }
         ...
         this._itemAwardPosY = this._itemAwardPosY + Math.ceil(this._constantItemAwards.length / 2) * this.REWARDCELL_HEIGHT;
         if(this._optionalItemAwards.length > 0)
         {
            ...
            this._itemAwardPosY = this._itemAwardPosY + 22;
            this.drawItemAwardSet(this._optionalItemAwards,true);
            this._itemAwardPosY = this._itemAwardPosY + Math.ceil(this._optionalItemAwards.length / 2) * this.REWARDCELL_HEIGHT;
         }
         else
         {
            this._eligiblyWord.visible = false;
      ...
      private function addReward(param1:String, param2:int, param3:int, param4:Boolean = false, param5:String = "") : void
      {
         ...
         else
         {
            if(this._info.data && this._info.data.quality)
            {
               param2 = param2 * this._info.data.quality;
            }
