...
{
    public class CASE1207A : BasePetEffect
    {
        private int int_0;
        private int int_1;
        private int int_2;
        ...
        private int int_5;
        private int int_6;
        public CASE1207A(int count, int probability, int type, int skillId, int delay, string elementID) : base(ePetEffectType.CASE1207A, elementID)
        {
            this.int_1 = count;
            this.int_4 = count;
        ...
        {
            CASE1207A cE = living.PetEffectList.GetOfType(ePetEffectType.CASE1207A) as CASE1207A;
            if (cE != null)
            {
