package room.view
{
   ...
   public class RoomViewerItem extends Sprite implements Disposeable
   {
      ...
      private function init() : void
      {
         ...
         {
            this._addFriendBtn.x = this._addFriendBtn.x - (LONG - SHORT);
            this._viewInfoBtn.x = this._viewInfoBtn.x - (LONG - SHORT);
            this._kickOutBtn.x = this._kickOutBtn.x - (LONG - SHORT);
            this._nameTxt.width = this._nameTxt.width - (LONG - SHORT);
         }
