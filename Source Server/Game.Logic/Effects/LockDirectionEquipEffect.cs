...
namespace Game.Logic.Effects
{
  public class LockDirectionEquipEffect : BasePlayerEffect
  {
    ...
    private void ChangeProperty(Player player)
    {
      ...
      player.Game.AddAction((IAction) new LivingSayAction((Living) player, LanguageMgr.GetTranslation("LockDirectionEquipEffect.msg"), 9, 0, 1000));
    }
      ...
      int criticalAmount)
    {
      if (!this.IsTrigger)
        return;
      target.AddEffect((AbstractEffect) new LockDirectionEffect(2), 0);
    }
