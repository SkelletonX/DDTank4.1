...
{
    public class CASE1206A : BasePetEffect
    {
        private int int_0;
        private int int_1;
        private int int_2;
        ...
        private int int_5;
        private int int_6;
        public CASE1206A(int count, int probability, int type, int skillId, int delay, string elementID) : base(ePetEffectType.CASE1206A, elementID)
        {
            this.int_1 = count;
            this.int_4 = count;
        ...
        {
            CASE1206A cE = living.PetEffectList.GetOfType(ePetEffectType.CASE1206A) as CASE1206A;
            if (cE != null)
            {
        ...
        private void method_1(Living living_0)
        {
            ...
            {
                this.int_6 = 300;
                if (living_0.Defence < (double)this.int_6)
                {
                    this.int_6 = (int)living_0.Defence - 1;
                }
