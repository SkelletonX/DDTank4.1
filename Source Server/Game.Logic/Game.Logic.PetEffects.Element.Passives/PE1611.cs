...
{
	public class PE1611 : BasePetEffect
	{
		...
		public PE1611(int count, int probability, int type, int skillId, int delay, string elementID)
			: base(ePetEffectType.PE1611, elementID)
		{
			m_count = count;
			m_coldDown = count;
		...
		{
			PE1611 pE = living.PetEffectList.GetOfType(ePetEffectType.PE1611) as PE1611;
			if (pE == null)
			{
