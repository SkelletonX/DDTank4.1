...
{
    public class CASE1360A : BasePetEffect
    {
        private int int_0;
        private int int_1;
        private int int_2;
        ...
        private int int_5;
        private int int_6;
        public CASE1360A(int count, int probability, int type, int skillId, int delay, string elementID) : base(ePetEffectType.CASE1360A, elementID)
        {
            this.int_1 = count;
            this.int_4 = count;
        ...
        {
            CASE1360A cE = living.PetEffectList.GetOfType(ePetEffectType.CASE1360A) as CASE1360A;
            if (cE != null)
            {
        ...
        private void method_1(Living living_0)
        {
            ...
            this.int_6 = living_0.MaxBlood * 6 / 100;
