package com.wirelust.as3zlib
{
   ...
   public final class ZStream
   {
      ...
      public function flush_pending() : void
      {
         ...
         this.next_out_index = this.next_out_index + _loc1_;
         this.dstate.pending_out = this.dstate.pending_out + _loc1_;
         this.total_out = this.total_out + _loc1_;
         this.avail_out = this.avail_out - _loc1_;
         this.dstate.pending = this.dstate.pending - _loc1_;
      ...
      public function read_buf(param1:ByteArray, param2:int, param3:int) : int
      {
         ...
         this.avail_in = this.avail_in - _loc4_;
         ...
         this.next_in_index = this.next_in_index + _loc4_;
         this.total_in = this.total_in + _loc4_;
         return _loc4_;
      }
